'use strict';
// Controlled stop of the lab-ti2-env launcher tree via the repo's (fixed) process-scope.
...
(async () => {
  ...
  const r = await s.terminateLauncher(owner, e => console.log(JSON.stringify(e).slice(0, 300)));
