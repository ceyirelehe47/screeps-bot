...
function archive(o){
 ...
 const manifest={kind:'cpu-recheck-VIII-archive/v1',refactorBase:K.REFACTOR,compatBase:K.COMPAT,compatClosedHead:closed?.closedHead||null,
