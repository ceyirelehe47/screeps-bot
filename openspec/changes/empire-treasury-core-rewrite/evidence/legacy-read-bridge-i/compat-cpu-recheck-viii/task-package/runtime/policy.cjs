...
const REFACTOR='a9f4cc04d99c8a8fda11f9c7e980861953341f03';
const COMPAT='2d28a6f146fc81e5b87be7cf5b70648352557797';
...
const EVIDENCE='openspec/changes/empire-treasury-core-rewrite/evidence/legacy-read-bridge-i/compat-cpu-recheck-viii';
const KIND='compat-cpu-recheck-VIII/v1',PUBLIC_KIND='compat-cpu-recheck-VIII-public/v1';
