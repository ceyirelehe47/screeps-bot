...
function profileLocal(repo){
 ...
 return {status:'TASK_XIV_LOCAL_REPLAY_VERIFIED',compiler,liveMemoryUsed:false,engineCpuMeasured:false,engineSpikeReproduced:null,exactOnlineTaskRecordsAvailable:false,
