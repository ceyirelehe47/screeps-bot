...
function archive(o){
 ...
 const manifest={kind:'cpu-recheck-VI-archive/v1',refactorBase:K.REFACTOR,compatBase:K.COMPAT,compatClosedHead:closed?.closedHead||null,
