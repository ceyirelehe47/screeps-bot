...
const REFACTOR='6891de86bd5bd7a2c896384965be1d2f070d087e';
const COMPAT='5080fda96418fefecfd8ddccc79a9649f6165bed';
...
const EVIDENCE='openspec/changes/empire-treasury-core-rewrite/evidence/legacy-read-bridge-i/compat-cpu-recheck-vi';
const KIND='compat-cpu-recheck-VI/v1',PUBLIC_KIND='compat-cpu-recheck-VI-public/v1';
...
function renderConfig(p){validProfile(p);return 'import type { CompatConfig } from "./treasuryCompatTypes";\n'+
 '/** CPU Recheck VI: four fixed points. Budget unchanged; not a production rollout. */\n'+
