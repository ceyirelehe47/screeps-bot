...
const REFACTOR='0c742a1534ebd64af9e483fcd6313c5d156ff6e1';
const COMPAT='91b9a99226a7a135a0e75b8a1d0db255eefe2200';
...
const EVIDENCE='openspec/changes/empire-treasury-core-rewrite/evidence/legacy-read-bridge-i/compat-diagnostic-envelope-optimization-xii-online-ii';
const KIND='compat-diagnostic-envelope-optimization-XII-online-II/v1',PUBLIC_KIND='compat-diagnostic-envelope-optimization-XII-online-II-public/v1';
...
function renderConfig(p){validProfile(p);return 'import type { CompatConfig } from "./treasuryCompatTypes";\n'+
 '/** Diagnostic Envelope Optimization XII Online II: four fixed points with IX attribution. Budget unchanged. */\n'+
