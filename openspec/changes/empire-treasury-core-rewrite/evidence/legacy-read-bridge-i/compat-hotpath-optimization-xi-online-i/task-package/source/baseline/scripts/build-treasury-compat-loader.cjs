...
const EXPECTED_OUTPUT_PATHS = Object.freeze([...Object.keys(FIXED_OUTPUTS), GENERATED].sort());
...
module.exports = { generate, main, sha, blob, GENERATED, FIXTURE, TEMPLATE, PROVENANCE, SOURCE_MANIFEST, MARKER,
  X, B, A, FIXED_OUTPUTS, EXPECTED_OUTPUT_PATHS, verifyOutputIdentities, applyOrCheckGenerated, verifyRoot, BASELINE_COMMIT, BUILD_VII_BLOB };
