...
function archive(o){
 ...
 put('HOTPATH-COMPARISON.json',Buffer.from(JSON.stringify(comparison,null,2)+'\n'));
 ...
 return {status:'HOTPATH_XI_EVIDENCE_ASSEMBLED',target,files:files.size,result:verified.status,comparison:comparison.status};
}
