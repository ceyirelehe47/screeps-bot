...
function env(){check(process.versions.node.split('.')[0]==='22','NODE22_REQUIRED');for(const n of ['NODE_OPTIONS','NODE_PATH','DEST','DEPLOY_ALLOW_DIRTY','NODE_TLS_REJECT_UNAUTHORIZED'])check(!process.env[n],'UNSAFE_ENVIRONMENT');}
