...
function analyze(dir,verification){
 ...
 return {kind:'XV-retry-I-time-budget-analysis/v1',runId:C.POLICY.parentRunId,
   capture:verification.status,closure:verification.closure,windowSelection:verification.windowSelection||null,
